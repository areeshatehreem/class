// link of stair case
https://medium.com/@mannycodes/how-to-solve-the-staircase-code-challenge-1f0f58dc5be3
...
/*
let json;
json.forEach(function(videos){
alert(videos.length[0] + "title: " +videos.title)
})
